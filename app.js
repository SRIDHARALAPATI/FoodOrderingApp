...
const {cloudinaryImageId,name,cuisines,avgRating,costForTwo, slaString}=resdata?.info;
  return(
    <div className="res-card">
      <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/"+resdata.info.cloudinaryImageId}></img>
      <h4>{name}</h4>
      <h4>{cuisines.join(", ")}</h4>
      <h4>{avgRating}</h4>
      <h4>{costForTwo}</h4>
...
const restaurantList=[
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/kodi-kura-chitti-gaare-kondapur-hitec-city-hyderabad-56169",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    "info": {
      "id": "300775",
      "name": "Krispy Kreme",
      "cloudinaryImageId": "l3q0nrl77wkcajftvtja",
      "locality": "Kothaguda",
      "areaName": "Kothaguda",
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/krispy-kreme-kothaguda-hyderabad-300775",
      "type": "WEBLINK"
    }
  },
  {
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/wow-momo-gachibowli-hyderabad-259986",
      "type": "WEBLINK"
    }
  },
  {
    "info": {
      ...
      "availability": {
        "nextCloseTime": "2024-01-03 16:30:00",
        "opened": true
      },
      "badges": {
  ...
  },
  {
    "info": {
      ...
      "cloudinaryImageId": "fsv5nnn6dqwdrkvuf1pl",
      "locality": "Hyderabad Kondapur LG",
      "areaName": "Kondapur",
      "costForTwo": "₹600 for two",
      "cuisines": [
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/mcdonalds-gourmet-burger-collection-lg-kondapur-hyderabad-395358",
      "type": "WEBLINK"
    }
  },
  {
